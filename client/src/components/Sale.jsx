        ...
        <section id='Sale' className='flex flex-col lg:flex-row justify-center items-center'>
            <div id='SaleContent' className='lg:w-[70%] p-16'>
                ...
                <h1 id="AboutMiddleText" className='text-5xl text-white mt-4'>
                    <span className='text-[#FF00D0]'>Lorem ipsum sit,</span> elit.  officia <span className='text-[#FF00D0]'>officiis</span> hjnregwe <span className='text-[#FF00D0]'>nesciunt, neque,</span> iusto tenetur.
                </h1>
                <Link to="/shop">
